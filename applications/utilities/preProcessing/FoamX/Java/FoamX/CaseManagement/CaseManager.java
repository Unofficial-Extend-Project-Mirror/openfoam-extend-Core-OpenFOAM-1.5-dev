    ...
    implements CaseStatusListener, ChangeListener
{
    ...
    public void closeAllCases()
    {
        try
        {
            ...
            // Close all cases.
            Enumeration enumEls = caseMap_.elements();
            while (enumEls.hasMoreElements())
            {
                // Get next case.
                CasePanel casePanel = (CasePanel)enumEls.nextElement();
            ...
            //caseNo = 0;
            //// Close all cases.
            //enumEls = casePostMap_.elements();
            //while (enumEls.hasMoreElements())
            //{
            //    // Get next case.
            //    CasePostPanel casePostPanel = (CasePostPanel)enumEls.nextElement();
            //
