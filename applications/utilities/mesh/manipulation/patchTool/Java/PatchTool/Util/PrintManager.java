...
import PatchTool.Util.OffScreenCanvas3D;
import PatchTool.PostApp;
    ...
    public void print(Dimension wantedDim, String fileName)
    {
        ...
        if (wantedDim.width == 0)
        {
            ...
            else
            {
                ...
                System.out.println("Using user specified height : " + wantedDim);
            }
        }
        else
        {
            if (wantedDim.height == 0)
            {
                ...
                System.out.println("Using user specified width : " + wantedDim);
            }
            else
            {
                System.out.println
...
//            pixelHeight = pixelWidth;
            ...
            System.out.println("Setting physscreen to " + pixelWidth + " " + pixelHeight);
