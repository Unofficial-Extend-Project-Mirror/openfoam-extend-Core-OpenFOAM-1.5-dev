 ...
 _dxf_user_modules()
{
    ...
    {
        extern Error m_foamGetRoots(Object *, Object *);
        DXAddModule("foamGetRoots", m_foamGetRoots, 0,
            0,
            1, "roots[cache:1]");
    }
    {
        extern Error m_foamGetCases(Object *, Object *);
        DXAddModule("foamGetCases", m_foamGetCases, 0,
            1, "rootDir",
            1, "caseNames[cache:1]");
    }
    {
        extern Error m_foamCreateDatabase(Object *, Object *);
        DXAddModule("foamCreateDatabase", m_foamCreateDatabase, 0,
            2, "rootDir", "caseName",
            1, "foamDatabase[cache:2]");
    }
    {
        extern Error m_foamReadMesh(Object *, Object *);
        DXAddModule("foamReadMesh", m_foamReadMesh, 0,
            1, "foamDatabase",
            2, "foamMesh[cache:2]", "mesh[cache:2]");
    }
    {
        extern Error m_foamGetTimes(Object *, Object *);
        DXAddModule("foamGetTimes", m_foamGetTimes, 0,
            2, "foamDatabase", "dummy",
            2, "timeValues[cache:2]", "timeNames[cache:2]");
    }
    {
        extern Error m_foamNearestTime(Object *, Object *);
        DXAddModule("foamNearestTime", m_foamNearestTime, 0,
            2, "timeValues", "timeEstimate",
            2, "timeValue[cache:1]", "timeIndex[cache:1]");
    }
    {
        extern Error m_foamChangeTime(Object *, Object *);
        DXAddModule("foamChangeTime", m_foamChangeTime, 0,
            3, "timeValue", "foamMesh", "mesh",
            4, "timeValue2[cache:0]", "foamMesh2[cache:0]", "mesh2[cache:0]", "lagrangianPositions[cache:0]");
    }
    {
        extern Error m_foamGetFieldNames(Object *, Object *);
        DXAddModule("foamGetFieldNames", m_foamGetFieldNames, 0,
            3, "foamDatabase", "timeValue", "fieldType",
            1, "fieldName[cache:1]");
    }
    {
        extern Error m_foamReadField(Object *, Object *);
        DXAddModule("foamReadField", m_foamReadField, 0,
            5, "fieldName", "fieldType", "foamMesh", "mesh", "lagrangianPositions",
            2, "volField[cache:2]", "pointField[cache:2]");
    }
    {
        extern Error m_foamIndexCells(Object *, Object *);
        DXAddModule("foamIndexCells", m_foamIndexCells, 0,
            2, "foamMesh", "mesh",
            1, "volField[cache:2]");
    }
    {
        extern Error m_foamGetSet(Object *, Object *);
        DXAddModule("foamGetSet", m_foamGetSet, 0,
            3, "foamMesh", "mesh", "setName",
            1, "volField[cache:2]");
    }
    {
        extern Error m_foamIndexPatches(Object *, Object *);
        DXAddModule("foamIndexPatches", m_foamIndexPatches, 0,
            2, "foamMesh", "mesh",
            1, "patchField[cache:2]");
    }
    {
        extern Error m_foamReadSTL(Object *, Object *);
        DXAddModule("foamReadSTL", m_foamReadSTL, 0,
            1, "foamDatabase",
            1, "stlMesh[cache:2]");
    }
    {
        extern Error m_foamFeatureLines(Object *, Object *);
        DXAddModule("foamFeatureLines", m_foamFeatureLines, 0,
            4, "foamMesh", "mesh", "patchNumbers", "featureAngle",
            1, "featureLines[cache:2]");
    }
    {
        extern Error m_foamShowConnections(Object *, Object *);
        DXAddModule("foamShowConnections", m_foamShowConnections, 0,
            2, "foamMesh", "mesh",
            1, "meshEdgeLines[cache:2]");
    }
}
