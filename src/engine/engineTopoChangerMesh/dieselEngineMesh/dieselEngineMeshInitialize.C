...
void Foam::dieselEngineMesh::checkAndCalculate()
{
    ...
    if (!foundPiston)
    {
        FatalErrorIn("Foam::dieselEngineMesh::checkAndCalculate()")
...
void Foam::dieselEngineMesh::setVirtualPositions()
{

    {
        ...
        if(!foundPistonFace)
        {
            FatalErrorIn("Foam::dieselEngineMesh::setVirtualPistonPosition()")
