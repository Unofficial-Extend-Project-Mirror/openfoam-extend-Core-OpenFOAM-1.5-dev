...
#include "verticalValvesGambit.H"
...
void Foam::verticalValvesGambit::calcMovingMaskTop(const label i) const
{
    if (debug)
    {
...
const Foam::scalarField& Foam::verticalValvesGambit::movingPointsMaskTop(const label i) const
{
    if(movingPointsMaskTopPtr_)
    {
...
void Foam::verticalValvesGambit::calcMovingMaskBottom(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValvesGambit::movingPointsMaskBottom(const label i) const
{
    if(movingPointsMaskBottomPtr_)
    {
...
void Foam::verticalValvesGambit::calcMovingMaskPiston() const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValvesGambit::movingPointsMaskPiston() const
{
    if(movingPointsMaskPistonPtr_)
    {
...
void Foam::verticalValvesGambit::calcMovingMaskPistonValves(const label i) const
{
    if (debug)
    {
        Info<< "void movingSquaresTM::calcMovingMasks() const : "
...
// Return moving points mask.  Moving points marked with 1
const Foam::scalarField& Foam::verticalValvesGambit::movingPointsMaskPistonValves(const label i) const
{
    if(movingPointsMaskPistonValvesPtr_)
    {
