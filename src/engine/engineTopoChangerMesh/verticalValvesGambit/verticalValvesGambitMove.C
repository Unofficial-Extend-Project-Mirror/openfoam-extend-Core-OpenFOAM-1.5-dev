...
void Foam::verticalValvesGambit::makeLayersLive()
{ 
    // Enable layering
...
void Foam::verticalValvesGambit::makeSlidersLive()
{
...
bool Foam::verticalValvesGambit::attached() const
{
...
void Foam::verticalValvesGambit::valveDetach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
void Foam::verticalValvesGambit::valveAttach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
void Foam::verticalValvesGambit::prepareValveDetach()
{
    // Enable sliding interface
    forAll (topoChanger_, modI)
    {
...
bool Foam::verticalValvesGambit::update()
{
...
#       include "movePistonPointsGambit.H"
#       include "moveValvePointsGambit.H"
        movePoints(newPoints);
#       include "poppetDeformationGambit.H"
        newPoints = points();
        setVirtualPositions();
    }
    else
...
#       include "moveAllTogetherGambit.H"
        movePoints(mSolver.curPoints());
        setVirtualPositions();
        newPoints = points();
#       include "moveTopOfTheValvesGambit.H"
        movePoints(newPoints);
#       include "poppetDeformationGambit.H"
        newPoints = points();
        setVirtualPositions();
