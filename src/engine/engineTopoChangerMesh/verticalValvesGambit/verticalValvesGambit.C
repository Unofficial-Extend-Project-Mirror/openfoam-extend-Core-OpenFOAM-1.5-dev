...
namespace Foam
{
    defineTypeNameAndDebug(verticalValvesGambit, 0);
    addToRunTimeSelectionTable(engineTopoChangerMesh, verticalValvesGambit, IOobject);
}
...
bool Foam::verticalValvesGambit::realDeformation() const
{
...
Foam::verticalValvesGambit::verticalValvesGambit
(
    const IOobject& io
)
:
    ...
    valves_(*this, engTime().engineDict().lookup("verticalValvesGambit")),
...
void Foam::verticalValvesGambit::setBoundaryVelocity(volVectorField& U)
{
...
bool Foam::verticalValvesGambit::inValve(const point& p, const label& i) const
{
...
bool Foam::verticalValvesGambit::inPiston(const point& p) const
{
...
bool Foam::verticalValvesGambit::isACylinderHeadFace
(
