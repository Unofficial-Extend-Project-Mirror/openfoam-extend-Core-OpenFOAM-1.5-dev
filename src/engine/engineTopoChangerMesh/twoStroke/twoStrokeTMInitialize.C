...
void Foam::twoStrokeTM::checkAndCalculate()
{
    ...
    if (!foundPiston)
    {
        FatalErrorIn("Foam::twoStrokeTM::checkAndCalculate()")
...
void Foam::twoStrokeTM::setVirtualPistonPosition()
{
    ...
    if(!foundPistonFace)
    {
        FatalErrorIn("Foam::twoStrokeTM::setVirtualPistonPosition()")
