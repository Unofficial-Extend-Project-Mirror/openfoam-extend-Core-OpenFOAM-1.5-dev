...
//                 << " master point: " << slaveMeshPoints[pointI] << endl;
            ...
            {
                Pout<< "f";
                Pout<< newPoint << " = "<< projectedSlavePoints[pointI] << endl;
            }
        }
    }
...
//     Pout << "pointsIntoSlaveEdges: " << pointsIntoSlaveEdges << endl;
    ...
    if (debug > 1)
    {
        ...
        writeVTK
        (
            slaveFaceZoneID_.name() + "ProjectedAdjustedSlave",
    ...
    if (debug > 1)
    {
        ...
        writeVTK
        (
            slaveFaceZoneID_.name() + "EnrichedPatch",
    ...
    if (debug > 1)
    {
        ...
        writeVTK
        (
            slaveFaceZoneID_.name() + "CutFacesPatch",
            cutPatch.localPoints(),
